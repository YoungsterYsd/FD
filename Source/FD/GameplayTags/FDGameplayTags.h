...
namespace FDGameplayTags
{
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(MoveDirection_F_L_90);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(MoveDirection_B_L_90);
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(MoveDirection_B_R_90);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(MoveDirection_F_R_90);
